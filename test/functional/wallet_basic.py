...
class WalletTest(GenesisTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 GENX from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 GENX with subtract fee from amount
        ...
        # Sendmany 10 GENX with subtract fee from amount

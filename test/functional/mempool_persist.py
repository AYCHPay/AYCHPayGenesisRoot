...
By default, genesisd will dump mempool on shutdown and
...
class MempoolPersistTest(GenesisTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give genesisd a second to reload the mempool
        ...
        self.log.debug("Prevent genesisd from writing mempool.dat to disk. Verify that `savemempool` fails")

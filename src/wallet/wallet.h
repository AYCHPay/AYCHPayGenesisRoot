...
#ifndef GENESIS_WALLET_WALLET_H
#define GENESIS_WALLET_WALLET_H
...
//! -txconfirmtarget default - moved to params (nTxMinConfirmations)
...
public:
     ...
     * on this Genesis node, and set to 0 for transactions that were created
...
public:
    ...
    // Masternodes
    // Get GENX output and keys which can be used for the Masternode

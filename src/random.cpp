...
static void RDRandInit()
{
    ...
    if (__get_cpuid(1, &eax, &ebx, &ecx, &edx) && (ecx & CPUID_F1_ECX_RDRAND)) {
        LogPrintG(BCLogLevel::LOG_NOTICE, BCLog::RAND, "[RAND] Using RdRand as an additional entropy source\n");
...
static void RandAddSeedPerfmon()
{
    ...
    if (ret == ERROR_SUCCESS) {
        ...
        LogPrintG(BCLogLevel::LOG_NOTICE, BCLog::RAND, "[RAND] %s: %lu bytes\n", __func__, nSize);
    } else {

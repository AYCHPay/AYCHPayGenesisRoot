...
public:
    ...
    void Unserialize(Stream& s)
    {
        ...
        if (nLost + nLostUnk > 0) {
            LogPrintG(BCLogLevel::LOG_ERROR, BCLog::ADDRMAN, "[AddressManager] Lost %i new and %i tried addresses due to collisions\n", nLostUnk, nLost);
        }
    ...
    void Check()
    {
#ifdef DEBUG_ADDRMAN
        {
            ...
            int err;
            if ((err=Check_()))
			    LogPrintG(BCLogLevel::LOG_ERROR, BCLog::ADDRMAN, "[AddressManager] Consistency Check Failed! err=%i\n", err);
        }
#endif
    }

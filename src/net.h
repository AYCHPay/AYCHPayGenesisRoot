...
#ifndef GENESIS_NET_H
#define GENESIS_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in Genesis Masternode,
    // because it's used in many Genesis Masternode-specific places (masternode).

...
#ifndef GENESIS_QT_GENESISUNITS_H
#define GENESIS_QT_GENESISUNITS_H
...
/** Genesis unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GenesisUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GenesisUnits(QObject *parent);
    ...
    //! Number of Genxis (1e-8) per unit
    ...
    //! Return maximum number of base units (Genxis)
    static CAmount maxMoney();

private:
    QList<GenesisUnits::Unit> unitlist;
};
typedef GenesisUnits::Unit GenesisUnit;

#endif // GENESIS_QT_GENESISUNITS_H

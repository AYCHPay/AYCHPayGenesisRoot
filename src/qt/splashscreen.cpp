    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightText1  = QChar(0xA9) + QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Genesis Official developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 12, copyrightText1);

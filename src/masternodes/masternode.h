...
// static const int MASTERNODE_SIGNHASH_THRESHOLD          = 600000;
...
#define DEFAULT_SENTINEL_VERSION 0x015654
// daemon version before implementation of nDaemonVersion in CMasternodePing
// this does not *really* apply... but set it to the version masternodes were implemented
#define DEFAULT_DAEMON_VERSION BLOCKRESTRUCTURE_AND_MASTERNODES
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        // converting from/to old format no longer required as this is a fresh implemetation
...
struct masternode_info_t
{
    ...
    int64_t nTimeLastPaidPrimary = 0;
    int64_t nTimeLastPaidSecondary = 0;
    int64_t nTimeLastPing = 0; //* not in CMN
    bool fInfoValid = false; //* not in CMN
};

//
// The Masternode Class. For managing the Genesis Masternode process. It contains the input of the GENX, signature to prove
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        READWRITE(nTimeLastPaidPrimary);
    ...
    int GetLastPaidBlockSecondary() const { return nBlockLastPaidSecondary; }

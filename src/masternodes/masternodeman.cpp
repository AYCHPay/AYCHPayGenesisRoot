...
void CMasternodeMan::DsegUpdate(CNode* pnode, CConnman& connman)
{
    ...
    LogPrint(BCLog::MN, "CMasternodeMan::DsegUpdate -- %s", pnode->addr.ToString());
}
    ...
    if (mnb.CheckOutpoint(nDos)) {
        ...
        if (fMasternodeMode && mnb.pubKeyMasternode == activeMasternode.pubKeyMasternode) {
            ...
            if (mnb.nProtocolVersion == PROTOCOL_VERSION) {
                ...
                LogPrint(BCLog::MN, "CMasternodeMan::CheckMnbAndUpdateMasternodeList -- wrong PROTOCOL_VERSION, re-activate your MN: message nProtocolVersion=%d  PROTOCOL_VERSION=%d\n", mnb.nProtocolVersion, PROTOCOL_VERSION);
                return false;
            }
        }
        mnb.Relay(connman);
